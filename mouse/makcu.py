...
class makcu_controller:
    ...
    keyboard_states = {}  # Store remote keyboard states
    ...
    def get_button_state(button_name: str):
        ...
        if button_name in makcu_controller.button_states:
            return makcu_controller.button_states.get(button_name, False)
        # Fallback to keyboard keys
        return makcu_controller.keyboard_states.get(button_name, False)

    @staticmethod
    def update_key_state(key_name: str, is_pressed: bool):
        makcu_controller.keyboard_states[key_name] = is_pressed
